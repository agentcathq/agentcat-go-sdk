...
| [mcpgo/advanced](mcpgo/advanced) | 8082 | Full AgentCat options (Identify, Redact, Debug) with mark3labs/mcp-go |
...
| [officialsdk/advanced](officialsdk/advanced) | 8084 | Full AgentCat options (Identify, Redact, Debug) with the official Go MCP SDK |
